...
// echo $colors;	//errors(Array to string conversion)
...
// (ii) Associative Array //array ထဲမှာ keyname နဲ့လာ
...
// (iii) Multidimensional Array // Array ထဲမှာ Array ထပ်ရှိနေတာ

$paints = array(
	array("red","green","blue"),
	array("pen","pencil","ruler"),
	array("red","paper","plastic")
	);
